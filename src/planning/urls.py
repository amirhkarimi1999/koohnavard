...
urlpatterns = [
    ...
    path('<int:plan_id>/reportspam/', views.reportSpam, name='reportSpam'),
    path('<int:plan_id>/managepictures/', views.managePictures, name='managePictures'),
    path('<int:plan_id>/pulicpicture/<int:pic_id>/', views.publicPicture, name='publicPicture'),
    ...
    path('<int:plan_id>/addcriticism/<int:user_id>/', views.recordCriticism, name='addCriticism'),
]
